<head>      
<link rel="stylesheet" type="text/css" href="<?=base_url()?>/weixin/plugins20268e.css">
 </head>          
    <div class="main_hd">
        <h2>添加功能插件</h2>
        <div class="title_tab" id="js_menu" style="display:none;">
        </div>
    </div>
    <div class="main_bd">
        <div class="plugins_wrp">
            <p class="plugin_desc">你可以添加下列需要的功能，丰富公众号能力和体验</p>
            <dl>
                <dd>
                    <ul id="js_plugins">
<li class="item_wrp">
    <a class="plugin_item " href="https://mp.weixin.qq.com/cgi-bin/plugindetails?t=service/profile&pluginid=10005&action=intro&token=145239729&lang=zh_CN">
        <div class="plugin_icon"><img src="<?=base_url()?>/weixin/icon_groupReply_b.png"></div>
        ...
        <div class="plugin_content">
            <h3 class="title">群发功能</h3>
            <p class="desc">公众号可以向关注其账号的用户群发文字、图片、图文、语音、视频等消息。</p>
        </div>
    </a>
</li>

<li class="item_wrp">
    <a class="plugin_item no_extro" href="https://mp.weixin.qq.com/cgi-bin/plugindetails?t=service/profile&pluginid=10006&action=intro&token=145239729&lang=zh_CN">
        <div class="plugin_icon"><img src="<?=base_url()?>/weixin/icon_autoReply_b.png"></div>
        <div class="plugin_status">
            <i class="access"></i>
            <span class="status_txt">
        ...
        <div class="plugin_content">
            <h3 class="title">自动回复</h3>
            <p class="desc">公众号可以针对用户的行为来设置特定的回复内容和丰富的关键字回复规则。</p>
        </div>
    </a>
</li>

<li class="item_wrp">
    <a class="plugin_item " href="https://mp.weixin.qq.com/cgi-bin/plugindetails?t=service/profile&pluginid=10007&action=intro&token=145239729&lang=zh_CN">
        <div class="plugin_icon"><img src="<?=base_url()?>/weixin/icon_editor_b.png"></div>
        <div class="plugin_status">
            <i class="access"></i>
            <span class="status_txt">
        ...
        <div class="plugin_content">
            ...
            <p class="desc">公众号可以在会话界面底部设置各式各样的自定义菜单，并可为其设置响应动作。</p>
        </div>
    </a>
</li>

<li class="item_wrp">
    <a class="plugin_item no_extro" href="https://mp.weixin.qq.com/cgi-bin/plugindetails?t=service/profile&pluginid=10009&action=intro&token=145239729&lang=zh_CN">
        <div class="plugin_icon"><img src="<?=base_url()?>/weixin/icon_customerService_b.png"></div>
        <div class="plugin_status">
            <i class="access"></i>
            <span class="status_txt">
        ...
        <div class="plugin_content">
            <h3 class="title">多客服</h3>
            <p class="desc">为公众号提供客服功能，支持多人同时为一个公众号提供客服服务。</p>
        </div>
    </a>
</li>

<li class="item_wrp">
    <a class="plugin_item " href="https://mp.weixin.qq.com/device/getdeviceinfo?action=detail&token=145239729&lang=zh_CN">
        <div class="plugin_icon"><img src="<?=base_url()?>/weixin/icon_equipment_b.png"></div>
        <div class="plugin_status">
            <i class="access"></i>
            <span class="status_txt">
        ...
        <div class="plugin_content">
            ...
            <p class="desc">给公众号获得绑定设备和传输设备数据的能力，让您的设备与亿万微信用户相连接。</p>
        </div>
    </a>
</li>

<li class="item_wrp">
    <a class="plugin_item no_extro" href="https://mp.weixin.qq.com/cgi-bin/plugindetails?t=service/profile&pluginid=10008&action=intro&token=145239729&lang=zh_CN">
        <div class="plugin_icon"><img src="<?=base_url()?>/weixin/icon_shop_b.png"></div>
        <div class="plugin_status">
            <i class="access"></i>
            <span class="status_txt">
        ...
        <div class="plugin_content">
            <h3 class="title">微信小店</h3>
            <p class="desc">一站式的微信开店，帮助已开通微信支付的服务号实现快速便捷的开店和管理商品。</p>
        </div>
    </a>
</li>

<li class="item_wrp">
    <a class="plugin_item " href="https://mp.weixin.qq.com/advanced/tmplmsgapply?action=intro&t=tmplmsg/intro&token=145239729&lang=zh_CN">
        <div class="plugin_icon"><img src="<?=base_url()?>/weixin/icon_tmplMsg_b.png"></div>
        <div class="plugin_status">
            <i class="access"></i>
            <span class="status_txt">
        ...
        <div class="plugin_content">
            <h3 class="title">模板消息</h3>
            <p class="desc">通过模板消息接口，公众号能够向关注其账号的用户发送预设模板的消息。</p>
        </div>
    </a>
</li>
</ul>
...
<script type="text/javascript">
    ...
    window._points&&(window._points[2]=+new Date());
        ...
        <script type="text/javascript" src="./plugincenter_files/sea1fd8fc.js"></script>  
<script type="text/javascript" src="./plugincenter_files/lib1ec5f7.js"></script>  
<script type="text/javascript">
    window.wx ={
        version:"4.0.0",
        data:{
            ...
            time:"1411913424"||new Date().getTime()/1000
        },
        path:{
...
<script type="text/javascript" src="./plugincenter_files/wx200a31.js"></script>  
...
<li class="item_wrp">
    <a class="plugin_item {if index%2}no_extro{/if}" href="{plugin.url}">
        <div class="plugin_icon"><img src="{plugin.img}" /></div>
        <div class="plugin_status">
            <i class="access"></i>
            <span class="status_txt">
                {if plugin.need_check == 0}
                ...
                {else}
                    ...
                    {if plugin.status == 1}
                    <span class="warn">审核中</span>
                    {else if plugin.can_add == 1}
                    已添加                    {/if}
                {/if}        
            </span>
        </div>
...
<script type="text/html" id="tpl_menu">
    <ul class="tab_navs title_tab">
        <li class="tab_nav selected"><a href="/cgi-bin/plugincenter?t=service/plugins&act=all&token=145239729&lang=zh_CN">插件库</a></li>
        <li class="tab_nav"><a href="{url}">{name}</a></li>
    </ul>
</script>

<script type="text/javascript">
wx.cgiData = {
    data : {"plugins":[{"id":10005,"desc":"公众号可以向关注其账号的用户群发文字、图片、图文、语音、视频等消息。","status":3,"img":"https:\/\/res.wx.qq.com\/mpres\/htmledition\/images\/icon\/service\/icon_groupReply_b.png","url":"\/cgi-bin\/plugindetails?t=service\/profile&pluginid=10005&action=intro","name":"群发功能","price":"","need_check":0,"can_add":1},{"id":10006,"desc":"公众号可以针对用户的行为来设置特定的回复内容和丰富的关键字回复规则。","status":3,"img":"https:\/\/res.wx.qq.com\/mpres\/htmledition\/images\/icon\/service\/icon_autoReply_b.png","url":"\/cgi-bin\/plugindetails?t=service\/profile&pluginid=10006&action=intro","name":"自动回复","price":"","need_check":0,"can_add":1},{"id":10007,"desc":"公众号可以在会话界面底部设置各式各样的自定义菜单，并可为其设置响应动作。","status":3,"img":"https:\/\/res.wx.qq.com\/mpres\/htmledition\/images\/icon\/service\/icon_editor_b.png","url":"\/cgi-bin\/plugindetails?t=service\/profile&pluginid=10007&action=intro","name":"自定义菜单","price":"","need_check":0,"can_add":1},{"id":10009,"desc":"为公众号提供客服功能，支持多人同时为一个公众号提供客服服务。","status":3,"img":"https:\/\/res.wx.qq.com\/mpres\/htmledition\/images\/icon\/service\/icon_customerService_b.png","url":"\/cgi-bin\/plugindetails?t=service\/profile&pluginid=10009&action=intro","name":"多客服","price":"","need_check":0,"can_add":1},{"id":10024,"desc":"给公众号获得绑定设备和传输设备数据的能力，让您的设备与亿万微信用户相连接。","status":3,"img":"https:\/\/res.wx.qq.com\/mpres\/htmledition\/images\/icon\/service\/icon_equipment_b.png","url":"\/device\/getdeviceinfo?action=detail","name":"设备功能","price":"","need_check":0,"can_add":0},{"id":10008,"desc":"一站式的微信开店，帮助已开通微信支付的服务号实现快速便捷的开店和管理商品。","status":0,"img":"https:\/\/res.wx.qq.com\/mpres\/htmledition\/images\/icon\/service\/icon_shop_b.png","url":"\/cgi-bin\/plugindetails?t=service\/profile&pluginid=10008&action=intro","name":"微信小店","price":"500","need_check":1,"can_add":0},{"id":10011,"desc":"通过模板消息接口，公众号能够向关注其账号的用户发送预设模板的消息。","status":0,"img":"https:\/\/res.wx.qq.com\/mpres\/htmledition\/images\/icon\/service\/icon_tmplMsg_b.png","url":"\/advanced\/tmplmsgapply?action=intro&t=tmplmsg\/intro","name":"模板消息","price":"","need_check":1,"can_add":0}]},
    authinfo : {}
}
seajs.use('service/plugins');
</script>
