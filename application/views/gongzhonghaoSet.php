<link rel="stylesheet" type="text/css" href="https://res.wx.qq.com/mpres/htmledition/style/page/setting/setting_common2053f2.css"/>
...
<div class="main_hd"><h2>公众号设置</h2><div id="topTab" class="title_tab"><ul class="tab_navs title_tab" data-index="0">
    
    
    <li data-index="0" class="tab_nav first js_top  selected" data-id="info"><a href="https://mp.weixin.qq.com/cgi-bin/settingpage?t=setting/index&action=account&token=145239729&lang=zh_CN">帐号详情</a></li>
    
    
    
    <li data-index="1" class="tab_nav  js_top " data-id="function"><a href="https://mp.weixin.qq.com/cgi-bin/settingpage?t=setting/function&action=function&token=145239729&lang=zh_CN">功能设置</a></li>
...
<div class="main_bd">
    <div class="account_setting_area" id="settingArea">
        <ul>
            ...
            <h4>登录邮箱</h4>
            <div class="meta_opr">
                                <p><a href="https://mp.weixin.qq.com/acct/updateboundemail?t=setting/bind-email&action=bind&token=145239729&step=1&lang=zh_CN">修改</a></p>
                <p class="desc">(一个月内只能申请修改一次)</p>
                            </div>
            <div class="meta_content"><?
                        $qqStr ='';
            ...
            <div class="meta_content">
                <span>gh_<?= mb_strtolower(random_string('alnum', 12))?></span>
            </div>
            </li>
            ...
            <div class="meta_opr verify">
                                                                                                    年审时间：2015年03月08日 - 2015年06月06日<br>
                                                    于2014年06月06日完成微信认证的帐号资质审核，<br>于2014年06月07日完成微信认证的名称审核。                                            </div>
            <div class="meta_content">
            ...
            <li class="account_setting_item">
                <h4>主体信息</h4>
                <div class="meta_opr">
                    <a href="https://mp.weixin.qq.com/acct/contractorinfo?t=setting/owner-setting&action=info&lang=zh_CN&token=145239729">详情</a>
                </div>
                <div class="meta_content">石家庄赵心瑞文化艺术交流有限公司</div>
            </li>
            ...
            <h4>介绍</h4>
            <div class="meta_opr">
                                                                            <p><a id="modifyUserInfo" href="javascript:;" class="">修改</a></p>
                    <p class="desc">(一个月内功能介绍只能申请修改一次)</p>
                                                                    </div>
            
            <div class="meta_content">
                河北省易学应用专家、赵心瑞师从周易泰斗王东山老先生。近年因“扛起传统文化在新时代背景下的旗帜”，先后被河北卫视、河北青年报等十余家媒体连续报道；并以数万宝宝好评，成为河北易学应用协会首位获此殊荣的“中华鸿名翘楚”之星。            </div>
            </li>
            ...
            <h4>所在地址</h4>
            <div class="meta_opr">
                                <a href="https://mp.weixin.qq.com/cgi-bin/settingpage?action=sosomap&lang=zh_CN&token=145239729">设置</a>
                            </div>
            <div class="meta_content">
            ...
            <div class="meta_content">
                <a target="_blank" class="verifyInfo" title="点击下载" href="#">
                    <!--<img src="./gongzhonghaoSet_files/getqrcode" width="150">-->
                    <div id="qrcodeCanvas" width="150"></div>
                </a>
            </div>
            </li>
...
<script type="text/javascript">
    window.wx ={
        ...
        data:{
            ...
            time:"1411912396"||new Date().getTime()/1000
        },
        path:{
...
<script type="text/javascript" src="<?=base_url()?>weixin/qrcode/jquery.qrcode.js"></script>
<script type="text/javascript" src="<?=base_url()?>weixin/qrcode/qrcode.js"></script>
<script>
...
define('widget/processor_bar.css', [], function(){return null;});</script>
<script type="text/javascript" src="<?=base_url()?>weixin/top20a85f.js"></script>
<script type="text/javascript" src="<?=base_url()?>weixin/index1f5e74.js"></script>
<script type="text/javascript">
    var page_dom_load_id = 23545, page_dom_load_key = 48;
var page_onload_id = 23545, page_onload_key = 49;
var page_js_script_id = 23545, page_js_script_key = 50;
var page_ava_id = 23545, page_ava_key = 51;
</script>



<script id="tpl_avatar" type="text/html">
    <div class="processor_bar_wrp" id="Js_stepBar"></div>
    <div class="setting_dialog_content avatar_setting protocol" id="step1Desc">
        <dl class="protocol_content">
            <dt>修改协议:</dt>
            <dd>1. 修改头像需经过审核。</dd>
            <dd>2. 每月有一次申请修改头像资格。</dd>
            <dd>3. 审核成功，则通过。审核失败，则等到下个月才能重新申请。</dd>
            <dd>4. 新头像要与公众号名称相符。</dd>
            <dd class="pic_area"><i class="icon_protocol"></i></dd>
        </dl>
    </div>
    <div class="setting_dialog_content avatar_setting modify" id="step2Desc" style="display:none;" >
        <div class="modify_content">
            <div id="cropImgArea" class="avatar_crop_area">
                <p class="crop_tips">你可以对图片进行裁切，并预览最终生成的头像效果。</p>
                <div class="crop_wrp">
                    <div id="largeHeadImg" class="crop_placeholder edit"></div>
                    <div id="midHeadImg" class="crop_placeholder preview"></div>

                    <div class="upload_box">
                        <div class="upload_area">
                            <a href="javascript:void(0);" class="btn btn_upload" id="Js_uploadAvatar">上传</a>
                        </div>
                        <p class="upload_tips">图片格式必须为以下格式：bmp, jpeg, jpg, gif<br>图片大小不可大于2M</p>
                    </div>
                    <button id="saveAvatar" style="display:none">保存</button>
                </div>
            </div>
            <div class="avatar_example_area">
                <img src="https://res.wx.qq.com/mpres/htmledition/images/icon/page-setting/avatar_example1e5b3a.jpg" alt="示例图">
                <strong>示例图</strong>
                <p>圆形头像将在公众号的详细信息页展示。<br/>其他地方都将展示方形头像。</p>
            </div>
        </div>
    </div>
    <div class="setting_dialog_content avatar_setting ensure" id="step3Desc" style="display:none;" >
        <div class="ensure_content">
            <h4>修改后一个月内不能更换。确定将头像改为以下:</h4>
            <div class="crop_placeholder preview">
                <img id="ensure_avatar_preview" src="">
            </div>
            <div class="tips_box">
                在手机或网页上展示为方或圆形头像            </div>
        </div>
    </div>
</script>


<script id="tpl_intro" type="text/html">
    <div>
        <div class="processor_bar_wrp" id="Js_stepBar"></div>
        <div class="setting_dialog_content protocol" id="step1Desc">
            <dl class="protocol_content">
                <dt>修改协议:</dt>
                <dd>1. 修改功能介绍需经过审核。</dd>
                <dd>2. 每月有一次申请修改功能介绍资格。</dd>
                <dd>3. 审核成功，则通过。审核失败，则等到下个月才能重新申请。</dd>
                <dd>4. 修改后的功能介绍要与公众号名称相符。</dd>
                <dd class="pic_area"><i class="icon_protocol"></i></dd>
            </dl>
        </div>
        <div class="setting_dialog_content modify" id="step2Desc" style="display:none;">
            <div class="modify_content">
                <label class="frm_label">请输入功能介绍</label>
                <div class="frm_controls">
                    <span class="frm_textarea_box"><textarea class="frm_textarea userinfo_input" id="modifyInput"></textarea></span>
                    <p class="frm_msg fail">
                    <i>●</i>
                    <span class="frm_msg_content">功能介绍长度为4-120个字</span>
                    </p>
                    <p class="frm_tips">审核通过后，你可以使用新的功能介绍，审核时间约为3个工作日。审核成功后1个月内不能再更改功能介绍。</p>
                </div>
            </div>
        </div>
        <div class="setting_dialog_content ensure" id="step3Desc" style="display:none;">
            <div class="ensure_content">
                <h4>修改后一个月内不能更换。确定将功能介绍改为以下:</h4>
                <div class="disabled_box" id="ensure_input">
                    修改后一个月内不能再次更换，确定将功能介绍改为                </div>
                <p class="mini_tips warn" id="error_tip" style="display:none"></p>
            </div>
        </div>
    </div>
</script>
...
<script id="tpl_nickname" type="text/html">
    <div>
        <div class="processor_bar_wrp" id="Js_stepBar"></div>
        <div class="setting_dialog_content protocol">
            <dl class="protocol_content">
                <dt>修改协议:</dt>
                <dd>1. 修改名称需经过审核。</dd>
                <dd>2. 每年有一次申请修改名称资格。</dd>
                <dd>3. 审核成功，则通过。审核失败，则等到下一年才能重新申请。</dd>
                <dd>4. 新名称要与公众号运营内容相符。</dd>
                <dd class="pic_area"><i class="icon_protocol"></i></dd>
            </div>
        </div>
        <div class="setting_dialog_content modify" style="display:none;" id="step2Desc">
            <div class="modify_content">
                <label class="frm_label">请输入新的名称:</label>
                <div class="frm_controls">
                    <span class="frm_input_box"><input type="text" id="modifyInput" class="frm_input nickname_input"></span>
                    <p class="frm_msg fail">
                    <i>●</i>
                    <span class="frm_msg_content">名称长度为2-16个字，不能含有特殊字符及“微信”等保留字</span>
                    </p>
                    <p class="frm_tips">审核通过后，你可以使用新名称，审核时间约为3个工作日。审核成功后一年内不能再更改名称</p>
                </div>
            </div>
        </div>
        <div class="setting_dialog_content ensure" style="display:none;" id="step3Desc">
            <div class="ensure_content">
                <h4>修改后一年内不能再次更换名称。确定要将名称改为:</h4>
                <div class="disabled_box" id="ensure_input">
                    修改后一年内不能再次更换名称。确定要将名称改为                </div>
            </div>
        </div>
    </div> 
</script>
...
<script id="tpl_wechatid" type="text/html">
    <div>
        <div class="simple_dialog_content">
            <div id="step1Desc">
                <span class="frm_input_box"><input class="frm_input" type="text" id="modAliasInput"></span>
                <p class="frm_tips">
                设置微信号后将无法更改。<br>
                可以使用6~20个字母、数字、下划线和减号，必须以字母开头。                </p>
            </div>
            <div id="step2Desc" style="display:none;" class="page_msg simple default">
                <div class="inner">
                    <div class="msg_icon_wrapper"><i class="icon_msg warn"></i></div>
                    <div class="msg_content">
                        <h4>是否确认将微信号设置为"<span></span>"？</h4>
                        <p>设置后将无法更改。</p>
                    </div>
                </div>
...
<script id="tpl_moresize" type="text/html">
    <div class="table_wrp qrcode_size" id="moreSize">
        <table class="table" cellspacing="0">
            ...
            <tbody class="tbody">
                ...
                <tr>
                    ...
                    <td class="table_cell"> <a class="icon18_common download_gray" href="{qrcode}&action=download&style=1&pixsize={value*28}">下载</a> </td>
                </tr>
                {/each}
            </tbody>
        </table>
...
<script id="tpl_authentication" type="text/html">
    <div class="page_msg  default popup_identity">  
        <div class="inner group">    
            <span class="msg_icon_wrapper"><i class="icon_msg warn"></i></span> 
            <div class="msg_content ">      
              <h4>是否需要验证用户身份来关注公众号</h4>        
             </div> 
        </div>
        <div class="frm_control_group">           
            <label for="" class="frm_radio_label">
                <i class="icon_radio"></i>
                                <input type="radio" class="frm_radio Js_authenticationRadio" id="Js_needAuth" value="1">需要，并设置你的验证问题<br>
                            </label>
                        <div class="identity_question_box" id="Js_question" style="display:none">
                            <input type="text" class="frm_input" spellcheck="false" value="">
                <span class="input_num" id="Js_wordNum" style="display:none;">26</span>
                <i class="select_icon_down"></i>
                <ul class="dropdown_data_list dn">
                    <li class="dropdown_data_item"><a href="javascript:;">请输入你的真实姓名，通过验证后才能加入此帐号</a></li>
                    <li class="dropdown_data_item"><a href="javascript:;">请输入你的手机号，通过验证后才能加入此帐号</a></li>
                </ul>
            </div>  
        </div>
        <div class="frm_control_group">
            <label for="" class="frm_radio_label">
                <i class="icon_radio"></i>
                                <input type="radio" class="frm_radio Js_authenticationRadio" value="0" checked>禁止 
                            </label>
        </div>
    </div>
</script>
...
<script type="text/javascript">
    cgiData = {
        ...
        links: {
qrcode: '/misc/getqrcode?fakeid=3095249804&token=145239729',
        rimgcrop: 'https://res.wx.qq.com/mpres/htmledition/images/cut-round1e5b3a.gif',
        rimgcropframe: 'https://res.wx.qq.com/mpres/htmledition/images/cut-round-frame1e5b3a.gif',
        spacer: 'https://res.wx.qq.com/mpres/htmledition/images/spacer1e5b3a.gif'
        }
    };
seajs.use('setting/index', wx_main);;
</script>