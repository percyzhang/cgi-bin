...
<div class="main_bd">
    ...
    <div class="sub_title_bar">
        <div class="info">
            <h3 id="page_title" style="">
                图文消息列表(共<span id="js_listCount">39</span>个)
            </h3>
        </div>
    </div>
        ...
        <div class="appmsg_col tj_item">
            <div class="inner" id="appmsgList1">
                                <span class="create_access"><i class="icon36_common add_gray"></i>                    <a href="https://mp.weixin.qq.com/cgi-bin/appmsg?t=media/appmsg_edit&action=edit&type=10&isMul=0&isNew=1&lang=zh_CN&token=145239729"><i class="icon_appmsg_create"></i><strong>单图文消息</strong></a>
                    <a href="https://mp.weixin.qq.com/cgi-bin/appmsg?t=media/appmsg_edit&action=edit&type=10&isMul=1&isNew=1&lang=zh_CN&token=145239729"><i class="icon_appmsg_create multi"></i><strong>多图文消息</strong></a>
                                    </span>
                            <div id="appmsg201854604"><div class="appmsg multi" data-id="201854604" data-fileid="201852312">
    <div class="appmsg_content">
            ...
            <div class="cover_appmsg_item">
                ...
                <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0" alt="" class="appmsg_thumb"></div>
            </div>
            
            <div class="appmsg_item">
                <img src="./materiaManager_files/0(1)" alt="" class="appmsg_thumb">
            ...
            <div class="appmsg_item">
                <img src="./materiaManager_files/0(2)" alt="" class="appmsg_thumb">
    ...
    <div class="appmsg_content">
            ...
            <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0(3)" alt="" class="appmsg_thumb"></div>
    ...
    <div class="appmsg_content">
            ...
            <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0(4)" alt="" class="appmsg_thumb"></div>
    ...
    <div class="appmsg_content">
            ...
            <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0(5)" alt="" class="appmsg_thumb"></div>
    ...
    <div class="appmsg_opr">
        ...
        <div class="appmsg_col tj_item">
            <div class="inner" id="appmsgList2"><div id="appmsg201756282"><div class="appmsg multi" data-id="201756282" data-fileid="201756437">
    <div class="appmsg_content">
            ...
            <div class="cover_appmsg_item">
                ...
                <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0(6)" alt="" class="appmsg_thumb"></div>
            </div>
            
            <div class="appmsg_item">
                <img src="./materiaManager_files/0(7)" alt="" class="appmsg_thumb">
    ...
    <div class="appmsg_content">
            ...
            <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0(8)" alt="" class="appmsg_thumb"></div>
    ...
    <div class="appmsg_content">
            ...
            <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0(9)" alt="" class="appmsg_thumb"></div>
    ...
    <div class="appmsg_opr">
        ...
        <div class="appmsg_col">
            <div class="inner" id="appmsgList3"><div id="appmsg201695798"><div class="appmsg multi" data-id="201695798" data-fileid="201695117">
    <div class="appmsg_content">
            ...
            <div class="cover_appmsg_item">
                ...
                <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0(10)" alt="" class="appmsg_thumb"></div>
            </div>
            
            <div class="appmsg_item">
                <img src="./materiaManager_files/0(11)" alt="" class="appmsg_thumb">
    ...
    <div class="appmsg_content">
            ...
            <div class="cover_appmsg_item">
                ...
                <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0(12)" alt="" class="appmsg_thumb"></div>
            </div>
            
            <div class="appmsg_item">
                <img src="./materiaManager_files/0(13)" alt="" class="appmsg_thumb">
    ...
    <div class="appmsg_content">
            ...
            <div class="appmsg_thumb_wrp"><img src="./materiaManager_files/0(14)" alt="" class="appmsg_thumb"></div>
    ...
    <div class="tool_area">
        <div class="pagination_wrp pageNavigator"><div class="pagination" id="wxPagebar_1411912147340">
...
<script type="text/javascript">
    ...
    window._points&&(window._points[2]=+new Date());
        ...
        <script type="text/javascript" src="./materiaManager_files/sea1fd8fc.js"></script>  
<script type="text/javascript" src="./materiaManager_files/lib1ec5f7.js"></script>  
<script type="text/javascript">
    window.wx ={
        version:"4.0.0",
        data:{
            ...
            time:"1411912158"||new Date().getTime()/1000
        },
        path:{
...
<script type="text/javascript" src="./materiaManager_files/wx200a31.js"></script>  
...
define('widget/media.css', [], function(){return null;});</script>
<script type="text/javascript" src="./materiaManager_files/appmsg.html1ee6db.js"></script>
<script type="text/javascript" src="./materiaManager_files/appmsg_list1ec5f7.js"></script>
