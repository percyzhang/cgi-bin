<link rel="stylesheet" type="text/css" href="https://res.wx.qq.com/mpres/htmledition/style/page/advanced/advanced_common1ec663.css"/>
<link rel="stylesheet" type="text/css" href="https://res.wx.qq.com/mpres/htmledition/style/page/advanced/advanced_dev_index1fd9be.css"/>
<link rel="stylesheet" type="text/css" href="https://res.wx.qq.com/c/=/mpres/htmledition/style/widget/processor_bar1ec663.css,/mpres/htmledition/style/widget/qrcode_scan1fd3ca.css" />                   
<div class="main_hd"><h2>开发者中心</h2><div class="title_tab" id="topTab"><ul class="tab_navs title_tab" data-index="0">
    
    
    <li data-index="0" class="tab_nav first js_top  selected" data-id="dev"><a href="./devloperCenter_files/devloperCenter.htm">配置项</a></li>
    
    
    
    <li data-index="1" class="tab_nav  js_top " data-id="group-alert"><a href="https://mp.weixin.qq.com/advanced/advanced?action=alarm&t=advanced/alarm&token=145239729&lang=zh_CN">接口报警</a></li>
    
    
</ul>
</div></div>
<div class="main_bd">
        <div class="developer_info_wrp">
	<div class="page_msg mini" id="js_authrized" style="display:none">
		<div class="inner group">
			...
			<div class="msg_content">
                <p>由于该公众号已授权给第三方公众号插件来进行管理，服务器配置以及其他消息通知（如小店的新订单通知）可能已失效，如果需要，你可以进入<a href="https://mp.weixin.qq.com/cgi-bin/component_unauthorize?action=list&t=service/auth_plugins&token=145239729&lang=zh_CN">授权插件管理</a>内取消授权。</p>
			</div>
		</div>
	</div>
	        <div class="developer_info_item">
            <div class="developer_info_hd">
                <h4 class="developer_info_title">开发者ID </h4>
            </div>
            <div class="developer_info_bd gray_desc">
                <div class="frm_control_group">
                    <label class="frm_label">AppId</label>
                    <div class="frm_controls frm_vertical_pt">wxa3ab354bb9cee3e9</div>
                </div>
                <div class="frm_control_group">
                    <label class="frm_label">AppSecret</label>
                    <div class="frm_controls frm_vertical_pt"> a184ffb51d1fd4fe3d9976a299ef46d4
                        <a href="javascript:;" id="Js_reset" class="extra_link" data-appid="wxa3ab354bb9cee3e9">重置</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="developer_info_item">
            <div class="developer_info_hd">
                                <h4 class="developer_info_title">服务器配置(<span class="tips">已启用</span>)</h4>
                <div class="developer_info_opr">
                    <a href="javascript:;" class="btn btn_warn" id="closeBt">停用</a>
                    <a href="https://mp.weixin.qq.com/advanced/advanced?action=interface&t=advanced/interface&token=145239729&lang=zh_CN" class="btn btn_default">修改配置</a>
                </div>
                            </div>
            <div class="developer_info_bd gray_desc">
                <div class="popover normal_flow pos_right server_switch_tips">
                    <div class="popover_inner">
                        <div class="popover_content">
                                                        停用服务器配置后，用户消息和开发者需要的事件推送，将不会被转发到该URL中                                                    </div>
                    </div>
                ...
                <div class="frm_control_group">
                    ...
                    <div class="frm_controls frm_vertical_pt">
                                                http://api.weiqudao.net/api/67cb28848C2144067cb21a0-1
                                            </div>
                </div>
                <div class="frm_control_group">
        ...
        <div class="developer_info_item">
            <div class="developer_info_hd">
                <h4 class="developer_info_title">
                    开发者工具                </h4>
            </div>
            <div class="developer_info_bd gray_desc">
                <p>开发者文档<a class="extra_link" href="http://mp.weixin.qq.com/wiki/index.php?title=%E9%A6%96%E9%A1%B5" target="_blank">点击进入</a></p>
                <p>在线接口调试工具<a class="extra_link" href="http://mp.weixin.qq.com/debug" target="_blank">点击进入</a></p>
                <p>开发者交流互助问答系统<a class="extra_link" id="js_bbsLink" href="http://mp.weixin.qq.com/qa/index.php?qa=user-login&to=index&appid=wxa3ab354bb9cee3e9&token=D3oTYhm1-k3EnLjfZRlCbYwFbhrv_8tP5zkH2aKvYEDhaP2Zlbadk24_FsxkP2K1N4D01a2abNdp8XmJoP7Gb3gWgsbQnpk9OqL6Fe6MMPx6156v55IXWErSfFmoNw-m&pluginid=bizqa" target="_blank">点击进入</a></p>
                <p>接口测试申请系统<a class="extra_link" href="http://mp.weixin.qq.com/debug/cgi-bin/sandbox?t=sandbox/login" target="_blank">点击进入</a></p>
            </div>
        </div>
        ...
        <div class="developer_info_item">
            <div class="developer_info_hd">
                <h4 class="developer_info_title">接口权限表</h4>
            </div>
            
            <div class="dev_right table_wrp">
                <table class="table" cellspacing="0">
                    <thead class="thead">
                        <tr>
                            <th class="table_cell type"> 服务包 </th>
                            <th class="table_cell desc"> 接口内容 </th>
                            <th class="table_cell benefit"> 接口状态 </th>
                    ...
                    <tbody class="tbody" id="list">
                        <tr>
                            ...
                            <td class="table_cell benefit" rowspan="3">
                                <span class="mini_tips icon_after">已获得</span>                                
                            </td>
                            <td class="table_cell opr"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="table_cell opr"></td>
                                                ...
                                                <tr>                            
                            <td class="table_cell type" rowspan="11">高级接口                            </td>
                            <td class="table_cell desc">
                                <a target="_blank" href="http://mp.weixin.qq.com/wiki/index.php?title=%E6%8E%A5%E6%94%B6%E8%AF%AD%E9%9F%B3%E8%AF%86%E5%88%AB%E7%BB%93%E6%9E%9C">语音识别</a>
                                                                <span id="voiceTxt">(已关闭)</span>
                                                            </td>
                            <td class="table_cell benefit" rowspan="11">                                
                                <span class="mini_tips icon_after">已获得</span>                                
                            </td>
                        ...
                        <tr>
                            <td class="table_cell desc"><a target="_blank" href="http://mp.weixin.qq.com/wiki/index.php?title=%E9%AB%98%E7%BA%A7%E7%BE%A4%E5%8F%91%E6%8E%A5%E5%8F%A3">高级群发接口<i class="icon_common new"></i></a></td>
                            <td class="table_cell opr"></td>
                        </tr>
                        <tr>
                            <td class="table_cell desc"><a target="_blank" href="http://mp.weixin.qq.com/wiki/index.php?title=%E8%AE%BE%E7%BD%AE%E7%94%A8%E6%88%B7%E5%A4%87%E6%B3%A8%E5%90%8D%E6%8E%A5%E5%8F%A3">设置用户备注名接口<i class="icon_common new"></i></a></td>
                            <td class="table_cell opr"></td>
                        </tr>
                        <tr>
                            ...
                            <td class="table_cell opr">
                                                                <a href="javascript:;" id="authBt">修改</a>
                                                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="table_cell desc">
                                <a target="_blank" href="http://mp.weixin.qq.com/wiki/index.php?title=%E8%8E%B7%E5%8F%96%E7%94%A8%E6%88%B7%E5%9C%B0%E7%90%86%E4%BD%8D%E7%BD%AE">获取用户地理位置</a><span id="localTxt">(已关闭)</span>
                            </td>
                            <td class="table_cell opr">
                        ...
                        <tr>
                            <td class="table_cell type">微信小店接口 </td>
                            <td class="table_cell desc"> <a target="_blank" href="http://mp.weixin.qq.com/wiki/index.php?title=%E5%BE%AE%E4%BF%A1%E5%B0%8F%E5%BA%97%E6%8E%A5%E5%8F%A3"> 微信小店接口 </a> </td>
                            <td class="table_cell benefit">
                                                        <span class="mini_tips icon_after jsAsk" data-type="shop">未获得<i class="icon_msg_mini ask"></i></span>
                                                        </td>
                            <td class="table_cell opr"></td>
                        </tr> 
						<tr>
                            <td class="table_cell type">模板消息 </td>
                            <td class="table_cell desc"> <a target="_blank" href="https://mp.weixin.qq.com/advanced/tmplmsg?action=faq&token=145239729&lang=zh_CN"> 模板消息 </a> </td>
                            <td class="table_cell benefit">
                                                        <span class="mini_tips icon_after jsAsk" data-type="tplmsg">未获得<i class="icon_msg_mini ask"></i></span>
                                                        </td>
                            <td class="table_cell opr"></td>
                        </tr> 						
                    </tbody>
...
<script type="text/javascript">
    ...
    window._points&&(window._points[2]=+new Date());
        ...
        <script type="text/javascript" src="./devloperCenter_files/sea1fd8fc.js"></script>  
<script type="text/javascript" src="./devloperCenter_files/lib1ec5f7.js"></script>  
<script type="text/javascript">
    window.wx ={
        version:"4.0.0",
        data:{
            ...
            time:"1411912550"||new Date().getTime()/1000
        },
        path:{
...
<script type="text/javascript" src="./devloperCenter_files/wx200a31.js"></script>  
...
define('widget/qrcode_scan.css', [], function(){return null;});</script>
<script type="text/javascript" src="./devloperCenter_files/MockJax1ec5f7.js"></script>
<script type="text/javascript" src="./devloperCenter_files/dev20268e.js"></script>
<script id="location" type="text/html">
    <div class="simple_dialog_content">
        <h3><i></i>请选择获取地理位置的模式</h3>
        <div class="frm_control_group">
            <input type="radio" class="localRadio" value="1" checked="true" data-label="用户进行对话时上报一次">
            <input type="radio" class="localRadio" value="2" data-label="用户进行对话后每隔5s上报一次">
        </div>
    </div>
</script>
...
<script type="text/javascript">
    wx.cgiData = {
        ...
        canDev:"1"==="1"?true:false,
        open:"1"==="1"?true:false,//开启关闭开发者模式
        dev :'3',//开发者状态0非开发者1、2开发者3企业开发者
        authUrl:"",
        location:"0",//0 没有 1 进入会话 2 连续上报
        is_biz_menu_open : '1' * 1, //  是否开启了自定义菜单
        is_biz_ivr_open : '0' * 1, //  是否开启了自动回复
                        selfMenu : '1' === "1" ? true : false,//自定义菜单可用
                        //开发者信息
        devInfo:[
            {name:"URL",value:"http://api.weiqudao.net/api/67cb28848C2144067cb21a0-1"},
            {name:"Token",value:"127891"},
            {name:"AppId",value:"wxa3ab354bb9cee3e9"},
            {name:"AppSecret",value:"a184ffb51d1fd4fe3d9976a299ef46d4"}
        ],
        status:"2"//审核状态 0未申请 1申请中 2已申请
        	,strategy_status: ({"strategy_status":{"wx_protect":1,"mobile":"+86158******91","wx_alias":"hsl8******96","protect_status":2}}).strategy_status
	        	,operation_seq: "201908904"
	        	,authrized: "0"
	        };
seajs.use("advanced/dev");
</script><div class="popover " style="display: none; position: absolute; left: 1110.5px; top: 1656px;">
    <div class="popover_inner">
        <div class="popover_content">必须是已<a target="_blank" href="https://mp.weixin.qq.com/merchant/store?action=detail&t=wxverify/detail&info=verify&token=145239729&lang=zh_CN">微信认证</a>、已接入<a target="_blank" href="https://mp.weixin.qq.com/cgi-bin/frame?t=business/index_frame&iframe=%2Fpaymch%2Fbusiness%3Ft%3Dbusiness%2Finfo%26action%3Doverview&nav=business&hide=0&token=145239729&lang=zh_CN">微信支付</a>的号、且在添加功能插件中申请微信小店功能成功的公众号，才可获得</div>
        
        
    </div>
    <i class="popover_arrow popover_arrow_out"></i>
    <i class="popover_arrow popover_arrow_in"></i>
</div><div class="popover " style="display: none; position: absolute; left: 1110.5px; top: 1697px;">
    <div class="popover_inner">
        <div class="popover_content">必须是已<a target="_blank" href="https://mp.weixin.qq.com/merchant/store?action=detail&t=wxverify/detail&info=verify&token=145239729&lang=zh_CN">微信认证</a>、已接入<a target="_blank" href="https://mp.weixin.qq.com/cgi-bin/frame?t=business/index_frame&iframe=%2Fpaymch%2Fbusiness%3Ft%3Dbusiness%2Finfo%26action%3Doverview&nav=business&hide=0&token=145239729&lang=zh_CN">微信支付</a>的服务号才可获得</div>
