...
var t = /^mp(\w)?\.weixin\.qq\.com$/.test(location.host) ? "https://res.wx.qq.com/" : "/", n = function(e) {
var t = e.lastIndexOf(".");
return t >= 0 ? e.substring(t) : "";
};
typeof MODULES != "undefined" && (t += "c/=");
var r = e.data.pathinfo = {
".js": "paymchres/zh_CN/htmledition/js/",
".tpl": "paymchres/zh_CN/htmledition/js/",
".html": "paymchres/zh_CN/htmledition/js/",
".css": "paymchres/htmledition/style/"
};
e.config({
base: t,
map: [ function(t) {
var i = n(t), s = e.data.base, o = t.substr(s.length);
!/mp\//.test(o) && i != ".css" && (o = "mp/" + o), !/mp\//.test(o) && i == ".css" && (o = "mp/mp-style/" + o);
