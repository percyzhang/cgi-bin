...
});define("ad_system/host_index.js", [ "common/wx/dialog.js" ], function(e, t, n) {
try {
var r = +(new Date);
"use strict";
var i = e("common/wx/dialog.js");
$("#open").click(function(e) {
if (wx.cgiData.fansNum > 5e4) {
...
type: "warn",
msg: "你的粉丝不足5万，暂时无法申请开通流量主功能|目前流量主功能正在公测，公测期间需要粉丝达到5万以上才能申请开通。",
buttons: [ {
text: "确定",
click: function() {
this.hide();
