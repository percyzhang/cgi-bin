...
});define("home/index.js", [ "common/wx/popup.js", "common/wx/Cgi.js", "common/wx/dialog.js", "biz_common/moment.js", "biz_common/cookie.js", "common/wx/pagebar.js" ], function(e, t, n) {
try {
var r = +(new Date);
"use strict", e("common/wx/popup.js");
var i = template.render, s = e("common/wx/Cgi.js"), o = e("common/wx/dialog.js"), u = e("biz_common/moment.js"), a = e("biz_common/cookie.js"), f = e("common/wx/pagebar.js"), l = wx.cgiData;
(function() {
var e = a.get("annual_review_dialog");
if (l.wxverify_annual_review == 1 && !e) {
a.set("annual_review_dialog", 1, 1, {
domain: "mp.weixin.qq.com"
});
var t;
l.wxverify_expired_time * 1e3 > +(new Date) ? t = "你的微信认证即将到期，请尽快进行年审|你好，你的微信认证将于%s到期，请尽快进行认证年审，否则将失去认证标识和相关接口权限——订阅号将无法使用自定义菜单，服务号的高级接口、多客服接口及微信支付接口将被停用。".sprintf("<span class='mini_tips warn'>" + u.unix(l.wxverify_expired_time).format("YYYY年MM月DD日") + "</span>") : t = "你的微信认证即将到期，请尽快进行年审|你好，请尽快进行认证年审，否则将失去认证标识和相关接口权限——订阅号将无法使用自定义菜单，服务号的高级接口、多客服接口及微信支付接口将被停用。";
var n = o.show({
type: "info",
title: "微信认证提示",
msg: t,
...
var e = "hasNotice";
seajs.use("biz_web/lib/store.js", function(t) {
if (!!t.get(e)) return;
s.get({
mask: !1,
...
var e = wx.cgiData.total_count, t = wx.cgiData.count, n = wx.cgiData.begin, r = new f({
...
var t = e.currentPage;
if (t == n) return;
return t--, location.href = wx.url("/cgi-bin/home?t=home/index&start=" + (t + 1)), !1;
}
});
}();
} catch (c) {
