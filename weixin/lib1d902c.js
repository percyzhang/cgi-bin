...
}), e.jQuery = e.$ = b, typeof define == "function" && define.amd && define.amd.jQuery && define("mp/biz_common/jquery-1.9.1.js", [], function(e, t, n) {
try {
var r = +(new Date);
return b;
} catch (i) {
wx.jslog({
src: "mp/biz_common/jquery-1.9.1.js"
}, i);
}
});
...
})(template, this), typeof define == "function" ? define("mp/biz_common/template-2.0.1.js", [], function(e, t, n) {
try {
var r = +(new Date);
n.exports = template;
} catch (i) {
wx.jslog({
src: "mp/biz_common/template-2.0.1.js"
}, i);
}
